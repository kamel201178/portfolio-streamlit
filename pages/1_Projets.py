...
cols = st.columns(2)
cols[0].image(ASSETS_PATH / "PB1_BC.png", caption="Page 1 – Synthèse KPI", use_container_width=True)
cols[1].image(ASSETS_PATH / "PB2_BC.png", caption="Page 2 – Détail ventes par région", use_container_width=True)
cols[0].image(ASSETS_PATH / "PB3_BC.png", caption="Page 3 – Analyse produits", use_container_width=True)
cols[1].image(ASSETS_PATH / "PB4_BC.png", caption="Page 4 – Performance commerciale", use_container_width=True)
